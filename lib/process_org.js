...
const dates = ['2006-01-01', '2008-01-01', '2010-01-01', '2012-01-01', '2014-01-01'];
...
module.exports = async (args) => {
  ...
  const allRepos = await listForOrg();
  const repos = slice(allRepos, 1);
  ...
  const enumerateFiles = async repo => glob('**/*.*', { cwd: repoDir(repo) });
